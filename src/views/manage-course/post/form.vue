...
import { addApi, updateApi, detailApi } from "./utils/post-api"
...
const { form, reset, submit, closeDialog } = useDialogForm({
	...
	default: Object.assign(
		{
			postId: "nextval('manage_course.post_post_id_seq'::regclass)",
			userId: "nextval('manage_course.post_user_id_seq'::regclass)",
			title: "",
			content: "",
			likeCount: "0",
			viewCount: "0",
