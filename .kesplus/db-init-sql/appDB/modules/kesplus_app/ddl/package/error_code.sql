CREATE OR REPLACE PACKAGE "kesplus_app"."error_code" AUTHID CURRENT_USER AS
    ...
    DELETE_CASCADE_ERROR CONSTANT TEXT := 'delete_cascade_error'; 
    ...
    KESPLUS_PERMISSION_DIR_ALREADY_INIT CONSTANT TEXT := 'kesplus_permission_dir_already_init'; 
    KESPLUS_ILLEGAL_CHARACTER_INIT CONSTANT TEXT := 'kesplus_illegal_character_init'; 
    KESPLUS_MENU_PERMISSION_NAME_EXIST CONSTANT TEXT := 'kesplus_menu_permission_name_exist'; 
    KESPLUS_PERMISSION_NAME_EXIST CONSTANT TEXT := 'kesplus_permission_name_exist'; 
    KESPLUS_PERMISSION_CODE_EXIST CONSTANT TEXT := 'kesplus_permission_code_exist'; 
    KESPLUS_PERMISSION_MENU_NAME_EXIST CONSTANT TEXT := 'kesplus_permission_menu_name_exist'; 
    KESPLUS_RENAME_MENU CONSTANT TEXT := 'kesplus_rename_menu'; 
end;
