CREATE OR REPLACE PACKAGE "kesplus_platform"."error_code" AUTHID CURRENT_USER AS
    ...
    USER_NOT_BIND_DEPT CONSTANT TEXT := 'kesplus_user_1004'; 
    ...
    KESPLUS_VIEW_NOT_EXIST CONSTANT TEXT := 'kesplus_view_not_exist'; 
    ...
    KESPLUS_EXCEPTION_TYPECODE_ERROR TEXT := 'kesplus_exception_typecode_error'; 
    USER_NOT_ENOUGH_AUTH TEXT := 'user_not_enough_auth'; 
end;
